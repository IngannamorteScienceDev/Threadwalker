...
OUTPUT_FILE = os.path.join(BASE_DIR, "data", "processed", "author_a_lemmas_advanced.csv")
FREQ_FILE = os.path.join(BASE_DIR, "data", "processed", "author_a_freq_advanced.csv")
...
def main():
    ...
    tqdm.pandas(desc="Лемматизация author_a")
