...
OUTPUT_FILE = os.path.join(BASE_DIR, "data", "processed", "author_b_lemmas.csv")
FREQ_FILE = os.path.join(BASE_DIR, "data", "processed", "author_b_freq.csv")
...
def main():
    ...
    print("Лемматизация сообщений author_b...")
